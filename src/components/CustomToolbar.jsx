...
const CustomToolbar = () => {
  return (
    <div id="toolbar" className="toolbar">
      ...
      <button className="ql-italic toolbar-hover">
        <BsTypeItalic className="toolbar-icon" />
        <p className="toolbar-text">Italic (⌘ I)</p>
      </button>
      <button className="ql-underline toolbar-hover">
        <AiOutlineUnderline className="toolbar-icon" />
        <p className="toolbar-text">Underline (⌘ U)</p>
      </button>
      <button className="ql-list toolbar-hover" value="bullet">
...
<p class="toolbar-text">Ordered List</p>
`;
icons["list"][
  "bullet"
