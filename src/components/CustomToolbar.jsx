...
const CustomToolbar = () => (
  <div id="toolbar" className="toolbar">
    ...
    <select className="ql-header" defaultValue="">
      ...
      <option value="" className="toolbar-icon">
        Normal
      </option>
    </select>
